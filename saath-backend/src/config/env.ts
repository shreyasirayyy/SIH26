...
const schema = z.object({
  ...
  AI_PROVIDER: z.string().default('fallback'), AI_API_KEY: z.string().optional(), GOOGLE_PLACES_API_KEY: z.string().optional(), GROQ_MODEL: z.string().default('openai/gpt-oss-20b'), ML_SERVICE_URL: z.string().url().optional(),
