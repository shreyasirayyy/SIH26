...
export interface Store { otp: Map<string, OtpChallenge>; cases: CaseRecord[]; timelines: TimelineEvent[]; users: Map<string, any>; records: Map<string, any[]>; }
