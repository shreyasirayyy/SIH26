...
const steps = [
	{ n: 5, label: "things you can see", icon: Eye },
	{ n: 4, label: "things you can feel", icon: Hand },
	{ n: 3, label: "things you can hear", icon: Headphones },
	{ n: 2, label: "things you can smell", icon: Leaf },
	{ n: 1, label: "thing you can taste", icon: Leaf },
];
		...
		<div className="px-5 pb-10 md:px-10 xl:px-14">
			...
			<div className="mx-auto mt-10 max-w-2xl">
				...
				<div className="surface mt-10 rounded-[28px] p-8 text-center md:p-12">
					...
					<p className="mt-8 text-xs font-bold uppercase tracking-[.18em] text-[#8a9b94]">Notice</p>
